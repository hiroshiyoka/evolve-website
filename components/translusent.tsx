...
type TranslusentProps = {
  children: React.ReactNode;
  className?: string;
};

export default function Translusent({
  children,
  className = "",
}: TranslusentProps) {
...
type TranslusentCardProps = {
  children: React.ReactNode;
  className?: string;
};

export function TranslusentCard({ children, className }: TranslusentCardProps) {
  return (
    <div
